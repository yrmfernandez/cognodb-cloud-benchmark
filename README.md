...
| Database | Point Lookup | 1-Hop | 2-Hop | 3-Hop | Indexed Lookup |
|---|---:|---:|---:|---:|---:|
| CognoDB | Complete | Complete | Complete | Complete | Complete |
| Memgraph | Complete | Complete | Complete | Complete | Complete |
| ArangoDB | Complete | Complete | Complete | Complete | Complete |
| FalkorDB | Complete | Complete | Complete | Complete | Complete |
| Neo4j | Complete | Complete | Complete | Complete | Complete |
...
Aggregation is not part of the current benchmark configuration and does not have results in `results/all_results.json`.
...
- Decide whether aggregation is required for the assignment; if so, implement and benchmark it for all five databases.
